...
// Modified to use TwoWire defined in main sketch file
...
void LiquidCrystal_I2C::begin(TwoWire * wire) {
	_wire = wire;
	//_wire->begin(); // Begin must be external, actually
	...
	//delay(50); // commented out as OpenSimPit will do the wait externally

	// Now we pull both RS and R/W low to begin commands
	expanderWrite(_backlightval);	// reset expanderand turn backlight off (Bit 8 =1)
	// delay(1000); // reduced as OpenSimPit will do the wait externally
	delay(10);
